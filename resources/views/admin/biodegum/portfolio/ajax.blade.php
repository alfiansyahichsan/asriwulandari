<script>
  ...
  // });
    ...
    /* Ajax Start */
    var url = "{{URL::Route('biodegum.portfolio.index')}}";
    ...
    $("#datalist").on('click', '.editModal', function(){
        ...
        $.get(url + '/' + id + '/edit', function (data) {
            ...
            if(data.image_source != ''){
                $("#fileimage").attr("href", "{{asset('/images/biodegum/portfolio')}}/"+data.image_source);
                $("#fileimage").show();
            }
            ...
            success: function (dataImage) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var newData = [
                            data.title,
                            '<img src="{{asset('images/biodegum/portfolio/')}}/'+data.image_source+'" width="300">',
