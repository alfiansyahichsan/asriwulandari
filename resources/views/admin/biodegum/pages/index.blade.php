...
@section('js')
    ...
    @include("admin.biodegum.pages.ajax")
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody id="datalist">
                                ...
                                <tr id="row{{$pg->id}}">
                                    <td>{{$pg->title}}</td>
                                    <td class="text-center"><img src="{{asset('storage/biodegum/page/'.$pg->image)}}" width="300"></td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-info editModal" data-toggle="modal" data-target="#editModal" value="{{$pg->id}}">
                                            Edit
                                        </button>
