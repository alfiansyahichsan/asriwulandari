<script>
    ...
    /* Ajax Start */
    var url = "{{URL::Route('pagesetting.index')}}";
    ...
    $("#btn-save").click(function (e) {
        ...
        $.ajax({    
            ...
            success: function (data) {
                ...
                var newData = [
                    data.title,
                    '<img src="{{asset('storage/asriw/page/')}}/'+data.image+'" width="300">',
                    '<button type="button" class="btn btn-info editModal" data-toggle="modal" data-target="#editModal" value="'+data.id+'">Edit</button>'
                ];
