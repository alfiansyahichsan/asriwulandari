...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{asset('lte-admin/plugins/iCheck/square/blue.css')}}">

</head>
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url('admin/dashboard') }}"><b>Admin</b> Area</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Fill in Your Credentials</p>
...
<!-- iCheck -->
<script src="{{asset('lte-admin/plugins/iCheck/icheck.min.js')}}"></script>
<script>
  $(function () {
    $('input').iCheck({
